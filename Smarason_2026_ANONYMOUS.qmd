...
abstract: |
  This observational study presents a 58-year national dataset of all fatal fire incidents in Iceland (1968--2025), compiled from the incident registry through systematic cross-verification of independent sources. The registry contains 113 fatal incidents (145 deaths), of which 93 are structure fires (116 deaths, 80%). Regulatory effectiveness is assessed using cohort comparison by building construction period and interrupted time series analysis (ITSA) at the 1999 regulatory breakpoint. Decade-aggregated mortality peaked in the 1970s (21.9 deaths per million per year) and declined to 4--7 per million from the 1990s onward, coinciding with successive modernization of fire safety legislation, building codes, and enforcement frameworks during the final decades of the twentieth century. In the subset with complete construction-year data (1996--2025), no fatal incidents occurred in buildings constructed after 1998. A person-years exposure approximation (0.57 vs. 0.00 per 100,000 across approximately 2.08 million post-1998 person-years; exact Poisson upper 95% bound: 0.14) confirms that the zero observation is statistically informative. ITSA identifies a significant pre-existing declining trend (IRR = 0.93/year, *p* < 0.001) and a level decrease at the 1999 intervention (IRR = 0.11, *p* = 0.010 Poisson; *p* = 0.12 negative binomial). Fatal incidents concentrate in the October--March heating season (58%). These findings are consistent with, though cannot conclusively demonstrate, the effectiveness of Iceland's fire safety regulatory framework. Key limitations include the small absolute number of events, reliance on modeled denominators, and the inability to separate regulatory effects from concurrent technological, sociodemographic, and behavioural changes. The findings highlight both the effectiveness and the institutional fragility of fire safety regulation, with documented enforcement lapses raising concerns about long-term sustainability.
keywords:
  - fire fatalities
