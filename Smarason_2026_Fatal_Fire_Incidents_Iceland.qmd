...
Iceland provides a useful case for studying the long-term effectiveness of fire safety regulation. Its small population (approximately 200,000 in 1968, growing to 388,000 in 2025) enables national-scale compilation of incident-level data, while its well-documented regulatory history allows trends to be interpreted against policy changes. Iceland's fire safety framework comprises four key components: a national fire authority (Brunamálastofnun) (Act No. 55/1969), fire prevention legislation (Act 74/1982), a substantially revised building regulation (Act 441/1998) that introduced mandatory smoke detectors and portable extinguishers in all dwellings, and the current fire prevention act (Act No. 75/2000) [WHATS THE DIFFERENCE BETWEEN THE FIRE PREVENTION LEGISLATION AND THE FIRE PREVENTION ACT - DID THIS REPLACE THE 1982 ACT?] [@Iceland1969; @Iceland1982; @Iceland1998; @Iceland2000]. The scale of the original challenge is illustrated by the 1968 fire prevention bill (Þingskjal 121), which noted that insurance payouts for fire damages between 1960–1967 equalled the cost of a major hydroelectric project, and that per-capita fire losses were two to three times higher [IS THE SOURCE MORE SPECIFIC?] than in neighbouring countries [DOES THIS MEAN THE NORDIC STATES? IF SO THEN WE JUST WORD IT ACCORDINGLY AS IT THEN FLOWS BETTER TO THE NEXT SENTENCE] [@Iceland1969; @Smarason2025practitioner]. In the Nordic context, published fire-death counts indicate that Iceland typically [MEANING IT USUALLY DOES SO OR JUST SOMETIMES?] records the lowest per-capita fire mortality (REF). Although country comparisons should be interpreted cautiously due to differences in definitions, follow-up practice, and ongoing harmonization; year-to-year variations within Iceland are also substantial and some Nordic statistics are pending revision [@MSB2023]. 

The Gjöll [A FOOTNOTE REFERENCE TO SAY WHAT THE WORD GJÖLL MEANS WOULD BE INTERESTING] Database on Fire and Fire Prevention (www.gjoll.is) was created to address the lack of a national incident-level dataset for fatal fires in Iceland. Covering 1968-2025 Gjöll was compiled through mining newspaper archives (e.g. timarit.is), yearbooks [FROM WHERE - Brunamálastofnun?], and official GOVERNMENT? reports, with source references for each record [@Smarason2025data; @Timarit]. 113 fatal fire incidents were identified  and verified against at least two independent sources. The registry and its preliminary descriptive results have also been disseminated to practitioner audiences (fire and EMS [SPELL OUT ACRONYMS]) in Iceland [@Smarason2025practitioner].

This study uses Gjöll to describe (i) long-term trends in fatal fire incidents and deaths, (ii) seasonal patterns and trends?, and (iii) the distribution of fire fatalities? fatal structure fires [ARE THESE WHERE SOMEONE DIED? BUILDINGS WERE TOTALLY DESTROYED?] by construction year, with particular attention paid to the role of building age and regulatory change in fire fatalities.
